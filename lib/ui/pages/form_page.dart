...
class _FormPageState extends State<FormPage> {
  ...
  DateTime _getEndDate(int periodLength) {
    if (_lastPeriodDate == null) {
      throw Exception('Start date is null');
    }
    return _lastPeriodDate!.add(Duration(days: periodLength - 1));
  }
  ...
  Future<void> _submitForm() async {
    ...
    final newPeriodLog = PeriodLog(
      id: Uuid().v4(),
      logDate: DateTime.now(),
      startDate: _lastPeriodDate!,
      endDate: _getEndDate(periodLength),
      cycleLength: cycleLength,
    );

    try {
      await MenstrualLogDatabase.instance.insertPeriodLog(newPeriodLog);
      ...
      List<PeriodLog> newData = await MenstrualLogDatabase.instance
          .getPeriodLogs();
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              ...
                              width:
                                  _dateError != null || _lastPeriodDate != null
                                  ? 2
                                  : 0,
                            ),
                          ),
